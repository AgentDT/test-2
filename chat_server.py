...
# ==============================================================================
                ...
                msg = self.group.list_all() #"...needs to use self.group functions to work"
...
# ==============================================================================
                ...
                # ---- start your code ---- # WORKS!
                print(msg)
                nim = json.loads(msg["target"])
                poem = self.sonnet.get_poem(nim) #"...needs to use self.sonnet functions to work"
                poem2 = "".join(poem)
                print('here:\n', poem2)
...
# ==============================================================================
                ...
                search_rslt = self.indices.values(msg["target"]) #"needs to use self.indices search to work"
